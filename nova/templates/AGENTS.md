...
- Use the subagent tool (`task`) to launch isolated worker tasks; inspect or control them with `check_subagent`, `wait_subagent`, `control_subagent`, and `task_output`.
...
- For background work, use background_run and check_background/task_output.
